...
- `chrisai-docs-dev-onboarding` for quick starts, tutorials, conceptual
  guides, and junior-developer learning flow
- `chrisai-docs-dev-api-reference` for module/class/function/config reference
  pages and structured lookup material
- `chrisai-docs-dev-formatting` for markdown normalization, outline cleanup,
...
developer learning sequence, use `chrisai-docs-dev-onboarding` first.

If the task is mainly about API lookup structure, use
`chrisai-docs-dev-api-reference` first.

If the task is mainly about headings, TOC, outline numbering, spacing, code
fences, or markdown normalization, use `chrisai-docs-dev-formatting` instead.
...
9. Apply `chrisai-docs-dev-formatting` last when final markdown or structure cleanup is needed.
