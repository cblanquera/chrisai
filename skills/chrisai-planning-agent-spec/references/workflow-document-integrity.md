...
4. `.agents/progress/manifest.md`, when progress is involved
5. `.agents/plans/feature-goals.md`, when deciding or updating feature goals
...
- `.agents/progress/manifest.md`, item files, batch files, logs, and outputs
...
9. **Feature-goal routing:** new user-identified feature goals are captured in
   `.agents/plans/feature-goals.md`, and bounded product streams become sibling
