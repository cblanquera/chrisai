...
Use this workflow when a `.agents/development/specs/` record set needs readiness, risk,
...
- `.agents/development/specs/<spec-id>/reviews/readiness-review.md`
- `.agents/development/specs/<spec-id>/reviews/findings.md`
- relevant `Q`, `RISK`, `ASM`, `DEC`, `AC`, or `EVD` records
- `.agents/development/specs/<spec-id>/status.md`
