...
Use this workflow when accepted `.agents/development/specs/` records should become an
...
6. accepted POC, wireframe, creative, validation, QA, feedback, and gap reports
...
5. Update implementation-facing routing files.
6. Generate proposed `TASK` records in `tasks.md`.
7. Generate sprint, release, or tool-specific views only when requested.
8. If the user wants active execution tracking, create progress items that link
