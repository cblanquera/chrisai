...
copy explorations, asset notes, and creative reviews.

## Read First

- `.agents/AGENTS.md`
- relevant spec brief, audience, non-goals, constraints, and acceptance
- existing `.agents/creatives/` notes

## May Update

- `.agents/creatives/direction.md`
- `.agents/creatives/assets.md`
- `.agents/creatives/reviews.md`
...
6. Record accepted direction, rejected alternatives, unresolved feedback, and
   open questions.
7. Promote durable product, UX, copy, or asset requirements into spec records
   before implementation or MVP freeze.
...
- durable scope changes are promoted back into specs
