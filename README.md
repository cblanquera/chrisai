...
ChrisAI knowledge, branding, chatting, coding, designing, graphics, social,
docing, and maintenance behaviors as reusable `skills/*/SKILL.md` folders.
...
| `chrisai-graphics` | Create standalone visual assets including article banners, social graphics, infographics, and explanatory or technical diagrams. |
...
| Graphics | [docs/graphics.md](docs/graphics.md) |
